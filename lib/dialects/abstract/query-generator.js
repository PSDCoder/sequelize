  ...
  */
  quote(obj, parent, force) {
    if (Utils._.isString(obj)) {
      ...
      var thereIsFieldMapping = parent && obj[i] in parent.fieldAttributeMap;
      var sql = (i > 0 ? this.quoteIdentifier(tableNames.join('.')) + '.' : (Utils._.isString(obj[0]) && parent && !thereIsFieldMapping ? this.quoteIdentifier(parent.name) + '.' : '')) + this.quote(thereIsFieldMapping ? parent.fieldAttributeMap[obj[i]] : obj[i], parent, force);
      if (i < len - 1) {
